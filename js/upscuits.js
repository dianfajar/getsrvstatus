	...
	*/
    ...
    function placeServer(data, ids) {
        ...
        case 1:
            ...
            break;
        case 2:
            data.statustxt = "Normal";
            data.statusicon = "ok";
            data.label = "success";
            data.alert = "";
            break;
        case 8:
            data.statustxt = "Abnormal";
        ...
        for (a = 0; a < uptimes.length; a++) {
            ...
            th = tm / 60;
            if (uptimes[a] >= 99.97) {
                uptimeb[a] = "Availability 100%";
            } else if (uptimes[a] <= 0) {
                uptimeb[a] = "Availability 0.00%<br>malfunction " + (a == uptimes.length - 1 ? '720 hour' : '24 hour');
            } else if (tm < 60) {
                uptimeb[a] = "Availability " + new Number(uptimes[a]).toFixed(2) + "%<br>Malfunction " + new Number(tm).toFixed(0) + " minute";
            } else {
                uptimeb[a] = "Availability " + new Number(uptimes[a]).toFixed(2) + "%<br>Malfunction " + new Number(th).toFixed(1) + " hour";
            }
        }
    ...
    function Type2Word(t, icon) {
        switch (t) {
        case 1:
            return (icon ? "<span class=\"glyphicon glyphicon-remove-sign\"></span> " : "") + "Malfunction";
        case 2:
